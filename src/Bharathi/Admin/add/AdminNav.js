      ...
      <div className="navbar">
        ...
        <div className="nav-links">
          ...
          <ul className="links">
            ...
            <li>
              <Link to="#" onClick={closeMenu}>Staff</Link>
              <i className='bx bxs-chevron-down j-arrow arrow'></i>
              <ul className="j-sub-menu sub-menu">
                <li><Link to={'/Staff'} onClick={() => { scrollToTop(); closeMenu(); }}>Staff - Add</Link></li>
                <li><Link to={'/Staff-View'} onClick={() => { scrollToTop(); closeMenu();  }}>Staff - View</Link></li>
                <li><Link to={'/Faculty-View'} onClick={() => { scrollToTop(); closeMenu();  }}>Faculty - View</Link></li>
              </ul>
            </li>
