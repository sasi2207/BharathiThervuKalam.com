...
const FingerPrintView = () => {
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      setLoading(true); // Start loading
      try {
        await axios.delete(`https://www.bharathithervukalam.com/api/fingerprints/delete/${id}`);
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`https://www.bharathithervukalam.com/api/fingerprints/update/${currentGroup.id}`, updatedFormData, {
        headers: {
