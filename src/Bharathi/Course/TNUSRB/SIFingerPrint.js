...
export default function Sifingerprint(){
  ...
  useEffect(() => {
    const fetchGroup1List = async () => {
      try {
        const response = await axios.get('https://www.bharathithervukalam.com/api/fingerprints/view');
  ...
  const downloadFile = async (id) => {
    ...
    try {
      const response = await axios.get(`https://www.bharathithervukalam.com/api/fingerprints/download/${id}`, {
        responseType: 'blob',
      });
  ...
  const handleCloseModal = () => {
    ...
    return(
        ...
        <h2 className="text-center">Recruitment for the Post of Sub-Inspector of Police (FINGER PRINT)</h2>
  
        <section className=" p-5 border bg-light mt-5">
          <h2 id='grop'>1. Age</h2>
          <p id='para'>
          The applicant should have completed the age of 20 years and should not have completed age above 30 years as on 1st July of the Notification year.
           The upper age limit relaxation given to certain categories are as follows:-
            <br />
            <br />
            ...
            <ul>
              ...
              <li>Transgender: 35 yrs</li>
              <li>Transgender, Destitute Widow: 37 yrs</li>
        ...
        <section className="section p-5 border bg-light">
          <h2 id='grop'>4. DEPARTMENTAL QUOTA:</h2>
          <p id='para'>
          20% reservation will be provided for Police Departmental 
          candidates who have completed 5 years of service as on the date of notification.
           Written Examination for departmental quota will be held separately. A departmental candidate may apply
            for both open and departmental quota, if he /she satisfies the eligibility criteria. Departmental candidates are
             exempted from Physical Measurement Test. However, they are required to attend the Certificate verification and Viva-voce.
          </p>
        </section>
  
        <section className="section p-5 border bg-light">
          <h2 id='grop'>5. SPECIAL CATEGORIES</h2>
          <p id='para'>
            ...
            <ul id='para'>
              <li> Age relaxation is given upto 47 years.</li>
              <li> The Ex-Servicemen who have not completed 3 years after discharge from service and the serving Armed Forces who are going to retire within one year from the last date of receipt of online application are eligible for applying for this recruitment</li>
            ...
            <ul>
              ...
              <li> The Destitute Widow candidates should obtain “Destitute Widow Certificate” from the designated Revenue Divisional Officer / Sub-Collector / Assistant Collector and upload the same along with the online application. Failing which they will not be considered under Destitute Widow category.</li>
            </ul>
        ...
        <h2 id="grop">Open Quota</h2>
        <ul id="para">
          <li><strong>Total Marks:</strong> 100</li>
          <li>
            <strong>Written Examination:</strong>
            <ul>
              <li>General Knowledge: 55 marks</li>
              <li>General Ability Test: 30 marks</li>
              <li>Total: 85 marks</li>
            </ul>
          </li>
          <li><strong>Special Marks:</strong> 5</li>
          <li><strong>Viva-Voce:</strong> 10 marks</li>
          <li><strong>Duration:</strong> 3 Hrs</li>
          <li><strong>Minimum Qualifying Marks:</strong> 30 out of 85</li>
          <li>
            <strong>Question Paper:</strong>
            <ul>
              <li>Total Questions: 170</li>
              <li>Marks per Question: 0.5</li>
            </ul>
          </li>
        </ul>
      </div>

      {/* Departmental Quota Section */}
      <div className="quota-section">
        <h2 id="grop">Departmental Quota</h2>
        <ul id="para">
          <li><strong>Total Marks:</strong> 100</li>
          <li>
            <strong>Written Examination:</strong>
            <ul>
              <li>General Knowledge: 45 marks</li>
              <li>General Ability Test: 30 marks</li>
              <li>Police Administration, Crime Investigation, and Basic Forensic Science: 40 marks</li>
              <li>Total: 85 marks</li>
            </ul>
          </li>
          <li>
            <strong>Special Marks:</strong>
            <ul>
              <li>Gold Medal: 5 marks</li>
              <li>Silver Medal: 3 marks</li>
              <li>Bronze Medal: 2 marks</li>
            </ul>
          </li>
          <li><strong>Viva-Voce:</strong> 10 marks</li>
          <li><strong>Duration:</strong> 3 hrs</li>
        ...
        <section className="section p-5 border bg-light">
          ...
          <p id='para'>
          In respect of open quota candidates, the number of candidates called for physical measurement will be 2 times of the number of vacancies.
           All the candidates qualified in physical measurement test shall be permitted for Viva-Voce.
            <br  />
            <br  />
            The Physical Measurement Test comprises of height measurement only. The minimum eligibility requirement is as follows:
            <br />
            <br  />
            <strong>MEN:</strong>
            <ul>
        ...
        <section className="section p-5 border bg-light">
          ...
          <p id='para'>
           ...
           <li> The Ex-servicemen and serving persons who are going to retire within one year qualified in written examination will be called for Certificate Verification in the ratio of 1:2 of vacancies.</li>
            </ul>
          </p>
        </section>
        ...
        <h2 className='text-center'>Sub-Inspector of Police (FINGER PRINT) Syllabus & Notes</h2>
